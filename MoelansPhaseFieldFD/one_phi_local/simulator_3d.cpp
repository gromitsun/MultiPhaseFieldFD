...

{
    ...
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 10, sizeof(Type), &_vars.L))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 11, sizeof(Type), &_paras.mk))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 12, sizeof(Type), &_paras.gamma))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 13, sizeof(Type), &_paras.kappa))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 14, sizeof(Type), &_paras.dx))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 15, sizeof(Type), &_paras.dt))
...
void Simulator_3D<Type>::steps(const Type dt, const unsigned int nsteps, const bool finish, const bool cputime)
{
    ...
    {
        _paras.dt = dt;
        CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 15, sizeof(Type), &_paras.dt))
...
void Simulator_3D<Type>::set_temp()
{
    ...
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 10, sizeof(Type), &_vars.L));
