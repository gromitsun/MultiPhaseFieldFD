...

{
    ...
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 4, sizeof(cl_mem), &_mem_M))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 5, sizeof(Type), &_vars.a2))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 6, sizeof(Type), &_vars.a1))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 7, sizeof(Type), &_vars.a0))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 8, sizeof(Type), &_vars.b2))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 9, sizeof(Type), &_vars.b1))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 10, sizeof(Type), &_vars.b0))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 11, sizeof(Type), &_vars.L))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 12, sizeof(Type), &_paras.Da))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 13, sizeof(Type), &_paras.Db))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 14, sizeof(Type), &_paras.mk))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 15, sizeof(Type), &_paras.gamma))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 16, sizeof(Type), &_paras.kappa))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 17, sizeof(Type), &_paras.dx))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 18, sizeof(Type), &_paras.dt))
...
void Simulator_3D<Type>::set_temp()
{
    ...
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 5, sizeof(Type), &_vars.a2));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 6, sizeof(Type), &_vars.a1));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 7, sizeof(Type), &_vars.a0));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 8, sizeof(Type), &_vars.b2));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 9, sizeof(Type), &_vars.b1));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 10, sizeof(Type), &_vars.b0));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 11, sizeof(Type), &_vars.L));
