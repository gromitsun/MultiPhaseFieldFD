...
template <typename Type>
void Simulator_3D<Type>::read_init_cond(const char * filename_phia, const char * filename_phib, const char * filename_comp)
{
...

{
    ...
    CHECK_RETURN_N(_kernel_step_phi_3d, clCreateKernel(program, "step_phi_3d", &err), err);
    CHECK_RETURN_N(_kernel_step_comp_3d, clCreateKernel(program, "step_comp_3d", &err), err);
    ...
    CHECK_RETURN_N(_mem_PhiB,clCreateBuffer(Simulator<Type>::context, CL_MEM_READ_WRITE|CL_MEM_COPY_HOST_PTR, _global_size[0]*_global_size[1]*_global_size[2]*sizeof(Type), _PhiB, &err),err)
    ...
    CHECK_RETURN_N(_mem_PhiBNext,clCreateBuffer(Simulator<Type>::context, CL_MEM_READ_WRITE|CL_MEM_COPY_HOST_PTR, _global_size[0]*_global_size[1]*_global_size[2]*sizeof(Type), _PhiB, &err),err)
    ...
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 1, sizeof(cl_mem), &_mem_PhiB))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 2, sizeof(cl_mem), &_mem_Comp))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 3, sizeof(cl_mem), &_mem_PhiANext))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 4, sizeof(cl_mem), &_mem_PhiBNext))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 5, sizeof(cl_mem), &_mem_U))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 6, sizeof(cl_mem), &_mem_M))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 7, sizeof(Type), &_vars.a2))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 8, sizeof(Type), &_vars.a1))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 9, sizeof(Type), &_vars.a0))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 10, sizeof(Type), &_vars.b2))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 11, sizeof(Type), &_vars.b1))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 12, sizeof(Type), &_vars.b0))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 13, sizeof(Type), &_vars.L))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 14, sizeof(Type), &_paras.Da))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 15, sizeof(Type), &_paras.Db))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 16, sizeof(Type), &_paras.mk))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 17, sizeof(Type), &_paras.gamma))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 18, sizeof(Type), &_paras.kappa))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 19, sizeof(Type), &_paras.dx))
    CHECK_ERROR(clSetKernelArg(_kernel_step_phi_3d, 20, sizeof(Type), &_paras.dt))
    
    CHECK_ERROR(clSetKernelArg(_kernel_step_comp_3d, 0, sizeof(cl_mem), &_mem_Comp))
    CHECK_ERROR(clSetKernelArg(_kernel_step_comp_3d, 1, sizeof(cl_mem), &_mem_U))
    CHECK_ERROR(clSetKernelArg(_kernel_step_comp_3d, 2, sizeof(cl_mem), &_mem_M))
    CHECK_ERROR(clSetKernelArg(_kernel_step_comp_3d, 3, sizeof(Type), &_paras.dx))
    CHECK_ERROR(clSetKernelArg(_kernel_step_comp_3d, 4, sizeof(Type), &_paras.dt))
...
void Simulator_3D<Type>::steps(const Type dt, const unsigned int nsteps, const bool finish, const bool cputime)
{
    ...
    for (unsigned int t = 0; t<nsteps; t++)
    {
        ...
        CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 1, sizeof(cl_mem), &_mem_PhiB))
        CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 3, sizeof(cl_mem), &_mem_PhiANext))
        CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 4, sizeof(cl_mem), &_mem_PhiBNext))
...
void Simulator_3D<Type>::set_temp()
{
    ...
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 7, sizeof(Type), &_vars.a2));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 8, sizeof(Type), &_vars.a1));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 9, sizeof(Type), &_vars.a0));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 10, sizeof(Type), &_vars.b2));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 11, sizeof(Type), &_vars.b1));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 12, sizeof(Type), &_vars.b0));
    CHECK_ERROR_EXIT(clSetKernelArg(_kernel_step_phi_3d, 13, sizeof(Type), &_vars.L));
...
void Simulator_3D<Type>::run()
{
    if(Simulator<Type>::current_step==0)
    {
        ...
        for (int i=0;i<10;i++)
        {
            ...
            std::cout << _PhiB[i+this->_dim.x/2-5+(this->_dim.y/2)*this->_dim.x+(this->_dim.z/2)*(this->_dim.y/2)*this->_dim.x] << "\t";
