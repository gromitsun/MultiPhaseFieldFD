...
/* Calculate polynomial coefficients in free energy function @ T */
template <typename Type>
inline void calc_coef(Type * a, Type * b, const Type T)
{
    // alpha phase
    a[0] = -11276.2 + 74092./T + 0.018532*sq(T) - 5.76423e-6*cu(T) + (223.048 - 38.5844*log(T))*T;
    a[1] = -10254.2 - 21614./T - 0.0211888*sq(T) + 5.89345e-6*cu(T) + (-92.5632 + 14.472*log(T))*T;
    a[2] = -68100. + 4.*T;
    a[3] = 86540. - 4.*T;
    a[4] = -4680.0;
    
    // liquid phase
    b[0] = -271.195 + 74092./T + 0.018532*sq(T) - 5.76423e-6*cu(T) + 7.9337e-20*pow(T,7) + (211.207 - 38.5844*log(T))*T;
    b[1] = -31740.5 - 21614./T - 0.0211888*sq(T) + 5.89345e-6*cu(T) - 8.51859e-20*pow(T,7)
    + (-88.6363 + 14.472*log(T))*T;
    b[2] = -1700. - 0.099*T;
    b[3] = -35534. + 47.534*T;
    b[4] = 139840. - 97.424*T;
