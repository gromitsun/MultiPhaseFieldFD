...
//    input_prefix = "/Volumes/Ashwin_SSD_2014_03/phasefield_test/gridrec/256/2/";
    ...
    out_prefix = input_prefix + "output_real/";
...
//                           (init_prefix + "phib.bin").c_str(),
    ...
    // Restart from previous calculations
//    sim.read_init_cond((out_prefix + "phia_100000.bin").c_str(), (out_prefix + "comp_100000.bin").c_str());
//    sim.write_mem();
//    sim.restart(100000); // set step counter
